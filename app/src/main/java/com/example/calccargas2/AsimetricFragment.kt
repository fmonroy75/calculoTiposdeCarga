...
class AsimetricFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_asimetric, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnCalcular.setOnClickListener {
            ...
            val tension1 = ((peso  * distancia2) / (distancia1 + distancia2)) * (1 / cos(Math.toRadians(angulo1)))
            val tension2 = ((peso  * distancia1) / (distancia1 + distancia2) )* (1 / cos(Math.toRadians(angulo2)))
            val tension1kg=tension1/9.81
            val tension2kg=tension2/9.81
            // Mostrar resultados
            val resultado = "Tensión en Tirante 1: %.2f N =>  %.2f Kg \nAngulo 1: %.2f\nTensión en Tirante 2: %.2f N =>  %.2f Kg\nAngulo 2: %.2f".format(tension1,tension1kg,angulo1, tension2,tension2kg,angulo2)
